...
enhanced_dir="/srv/storage/talc3@storage4.nancy.grid5000.fr/multispeech/calcul/users/jayilo/enhanced_audio_only/audio_only_wsj0_with_tcd_convex_normalized_sigma_ckpt"

ckpt_path="/srv/storage/talc3@storage4.nancy.grid5000.fr/multispeech/calcul/users/jayilo/sgmse/logs/audio_only_tcd_addloss_convex_normalized_sigma/1ehud2og/epoch=185-si_sdr=11.35.ckpt"
