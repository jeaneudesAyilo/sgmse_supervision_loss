...
#OAR -p cluster='grue'
# # Adapt as desired
#OAR -l host=1/gpu=2,walltime=15:00:00
...
enhanced_dir="/srv/storage/talc3@storage4.nancy.grid5000.fr/multispeech/calcul/users/jayilo/enhanced_audio_only/audio_only_wsj0_supervised_withprogressive"
