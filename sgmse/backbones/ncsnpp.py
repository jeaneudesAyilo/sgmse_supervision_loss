...
class NCSNpp(nn.Module):
    ...
    def __init__(self,
        ...
        **unused_kwargs
        ...
        if self.supervised: 
            assert embedding_type == 'none', f"In supersised case, embedding_type should be none but found {embedding_type}"
            assert conditional == False, f"In supersised case, conditional should be False but found {conditional}"
    ...
    def add_argparse_args(parser):
        ...
        parser.add_argument("--progressive_input", type=str, default="input_skip", choices=["input_skip","residual","none"], help="Choose the type of progressive input, none means no progressive growing path")
        parser.add_argument("--progressive", type=str, default="output_skip", choices=["output_skip","residual","none"], help="Choose the type of progressive output")   
        ...
        parser.add_argument("--conditional", action="store_false", help="whether to use also timestep t as input of the model or not")
    ...
    def forward(self, x, time_cond):
        ...
        if self.conditional and self.embedding_type in ['fourier','positional']:
