...
if __name__ == '__main__':
    ...
    parser.add_argument("--test_df_path", type=str, default = "/srv/storage/talc3@storage4.nancy.grid5000.fr/multispeech/calcul/users/jayilo/test_df.csv", help='File describing the original test data (which must have subdirectories clean/ and noisy/)')
